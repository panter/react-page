...
const HoverButtons = ({ editorState, editor, plugins, translations, }) => (React.createElement("div", null, plugins &&
    plugins.map((plugin, i) => plugin.hoverButtons &&
        plugin.hoverButtons.map((Button, j) => (React.createElement(Button, { translations: translations, key: `${i}-${j}`, editorState: editorState, editor: editor }))))));
const ToolbarButtons = ({ plugins, editorState, editor, translations, }) => (React.createElement("div", null, plugins &&
    plugins.map((plugin, i) => plugin.toolbarButtons &&
        plugin.toolbarButtons.map((Button, j) => (React.createElement(Button, { translations: translations, key: `${i}-${j}`, editorState: editorState, editor: editor }))))));
    ...
    render() {
        ...
        return (React.createElement("div", null,
            focused && (React.createElement(Portal, null,
                React.createElement(ThemeProvider, { theme: theme },
                    React.createElement("div", { className: 'ory-prevent-blur ory-plugins-content-slate-inline-toolbar ' +
                        ...
                        React.createElement(HoverButtons, Object.assign({ translations: this.props.translations, editorState: editorState, editor: this.editor.current }, this.props)))))),
            ...
            readOnly ? null : (React.createElement(BottomToolbar, { open: focused },
                React.createElement(ToolbarButtons, Object.assign({}, this.props, { translations: this.props.translations, editor: this.editor.current, editorState: editorState }))))));
    }
}
