...
const Inner = props => (React.createElement(Button, { icon: React.createElement(Devices, null), description: props.label, active: props.isPreviewMode, onClick: props.previewMode }));
