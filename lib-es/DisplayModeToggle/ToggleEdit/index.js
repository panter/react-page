...
const Inner = props => (React.createElement(Button, { icon: React.createElement(Create, null), description: props.label, active: props.isEditMode, onClick: props.editMode }));
