...
const Inner = props => (React.createElement(Button, { icon: React.createElement(ContentAdd, null), description: props.label, active: props.isInsertMode, onClick: props.insertMode }));
