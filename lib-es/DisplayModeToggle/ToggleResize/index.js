...
const Inner = props => (React.createElement(Button, { icon: React.createElement(Resize, null), description: props.label, active: props.isResizeMode, onClick: props.resizeMode }));
