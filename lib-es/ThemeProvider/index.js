...
class ThemeProvider extends React.Component {
    render() {
        return (React.createElement(JssProvider, { generateClassName: generateClassName },
            React.createElement(MuiThemeProvider, { theme: this.props.theme || theme }, this.props.children)));
    }
}
