...
const Dimensions = ({ getHeight = defaultGetHeight, getWidth = defaultGetWidth, className = null, elementResize = false, } = {}) => ComposedComponent => {
    class Decorator extends React.Component {
        ...
        render() {
            return (React.createElement("div", { className: classNames(className, 'ory-dimensions'), ref: this.onContainerRef },
                React.createElement(ComposedComponent, Object.assign({}, this.state, this.props, { updateDimensions: this.updateDimensions }))));
        }
    }
    return props => React.createElement(Decorator, Object.assign({}, props));
};
