...
const hotKeyHandler = (n, key) => pathOr(pathOr(() => Promise.resolve(), ['content', 'plugin', key], n), ['layout', 'plugin', key], n);
...
React.createElement(HotKeys, { handlers: handlers(props) }, props.children));
const mapStateToProps = createStructuredSelector({
    isEditMode,
    focus,
    // tslint:disable-next-line:no-any
    node: (state) => (id, _editable) => node(state, { id, editable: _editable }),
    // tslint:disable-next-line:no-any
