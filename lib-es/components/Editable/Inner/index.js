...
class Inner extends React.PureComponent {
    ...
    render() {
        ...
        const { cells = [] } = node;
        return (React.createElement("div", { className: "ory-editable ory-prevent-blur" }, cells.map((c) => (React.createElement(Cell, { rowWidth: containerWidth, rowHeight: containerHeight, editable: id, ancestors: [], key: c, id: c })))));
    }
}
