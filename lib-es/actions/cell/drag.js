 ...
 * @return {Action}
 */
export const cellHoverLeftOf = (drag, hover, level) => cellHover(drag, hover, level, PositionEnum.LEFT_OF);
/**
 ...
 * @return {Action}
 */
export const cellHoverRightOf = (drag, hover, level) => cellHover(drag, hover, level, PositionEnum.RIGHT_OF);
/**
 ...
 * @return {Action}
 */
export const cellHoverAbove = (drag, hover, level) => cellHover(drag, hover, level, PositionEnum.ABOVE);
/**
 ...
 * @return {Action}
 */
export const cellHoverBelow = (drag, hover, level) => cellHover(drag, hover, level, PositionEnum.BELOW);
/**
 ...
 * @return {Action}
 */
export const cellHoverInlineLeft = (drag, hover) => cellHover(drag, hover, 0, PositionEnum.INLINE_LEFT);
/**
 ...
 * @return {Action}
 */
export const cellHoverInlineRight = (drag, hover) => cellHover(drag, hover, 0, PositionEnum.INLINE_RIGHT);
/**
