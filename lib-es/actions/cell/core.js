 ...
 * @return {Action}
 */
export const updateCellContent = (id) => (state = {}) => ({
 ...
 * @return {Action}
 */
export const updateCellLayout = (id) => (state = {}) => ({
 ...
 * @return {Action}
 */
export const removeCell = (id, ids = []) => ({
    type: CELL_REMOVE,
    ts: new Date(),
    id,
 ...
 */
export const focusCell = (id) => ({ source, } = {}) => ({
    type: CELL_FOCUS,
    ts: new Date(),
    id,
    source,
 ...
 * Dispatch to focus a cell.
 */
export const focusPreviousCell = (id) => () => ({
