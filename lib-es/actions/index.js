...
export const actions = dispatch => ({
    cell: {
        updateContent: (id, state) => dispatch(updateCellContent(id)(state)),
        updateLayout: (id, state) => dispatch(updateCellLayout(id)(state)),
        remove: bindActionCreators({ removeCell }, dispatch).removeCell,
        resize: (id, size) => dispatch(resizeCell(id)(size)),
        focus: (id, source) => dispatch(focusCell(id)(source)),
        focusNext: (id) => dispatch(focusNextCell(id)()),
        focusPrevious: (id) => dispatch(focusPreviousCell(id)()),
