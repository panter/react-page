...
var HoverButtons = function (_a) {
    var editorState = _a.editorState, editor = _a.editor, plugins = _a.plugins, translations = _a.translations;
...
var ToolbarButtons = function (_a) {
    var plugins = _a.plugins, editorState = _a.editorState, editor = _a.editor, translations = _a.translations;
    return (React.createElement("div", null, plugins &&
        plugins.map(function (plugin, i) {
...
var Slate = /** @class */ (function (_super) {
    ...
    Slate.prototype.render = function () {
        var _a = this.props, focused = _a.focused, readOnly = _a.readOnly, plugins = _a.plugins;
        ...
        return (React.createElement("div", null,
            focused && (React.createElement(react_portal_1.Portal, null,
                React.createElement(ui_1.ThemeProvider, { theme: theme },
                    React.createElement("div", { className: 'ory-prevent-blur ory-plugins-content-slate-inline-toolbar ' +
                        ...
                        React.createElement(HoverButtons, __assign({ translations: this.props.translations, editorState: editorState, editor: this.editor.current }, this.props)))))),
            ...
            readOnly ? null : (React.createElement(ui_1.BottomToolbar, { open: focused },
                React.createElement(ToolbarButtons, __assign({}, this.props, { translations: this.props.translations, editor: this.editor.current, editorState: editorState }))))));
    };
    return Slate;
}(React.Component));
