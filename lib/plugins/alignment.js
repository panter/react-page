...
var AlignmentPlugin = /** @class */ (function (_super) {
    ...
    function AlignmentPlugin(props) {
        ...
        _this.toolbarButtons = [
            createButton('left', React.createElement(FormatAlignLeft_1.default, null), _this.DEFAULT_NODE),
            createButton('center', React.createElement(FormatAlignCenter_1.default, null), _this.DEFAULT_NODE),
            createButton('right', React.createElement(FormatAlignRight_1.default, null), _this.DEFAULT_NODE),
            createButton('justify', React.createElement(FormatAlignJustify_1.default, null), _this.DEFAULT_NODE),
        ];
        return _this;
    }
