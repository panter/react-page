...
var Inner = function (props) { return (React.createElement(index_1.default, { icon: React.createElement(Add_1.default, null), description: props.label, active: props.isInsertMode, onClick: props.insertMode })); };
var mapStateToProps = reselect_1.createStructuredSelector({ isInsertMode: display_2.isInsertMode });
var mapDispatchToProps = { insertMode: display_1.insertMode };
